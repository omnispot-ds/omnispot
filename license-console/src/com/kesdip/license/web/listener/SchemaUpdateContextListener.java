...
package com.kesdip.license.web.listener;
...
public class SchemaUpdateContextListener implements ServletContextListener {
	 ...
	 */
	public static final String SQL_PKG = "com/kesdip/license/web/util/schema/";

	/**
	 * The list of license console schema versions.
	 */
