...
public interface Component {
	 ...
	 * 
	 * @param parent
	 *            The parent component that this component is to be added to.
	 * @param timingMonitor
	 *            The timing monitor to schedule jobs with.
	 * @param player
	 *            The player that this component is a part of.
	 ...
	 * containers. These have to advertise this fact in their documentation, and
	 * throw a runtime exception should this interface be called.
	 * 
	 * @param component
	 ...
	 * example), then this interface will be used to extract this component from
	 * the KESDIP component.
	 * 
	 ...
	 * 
	 * @return One of the different states that determine if this component has
	 *         completed, or if it does not care about completion (most
	 *         components will fit this later category).
	 */
	 ...
	 * resources, we want to have a means of gathering all the resources that a
	 * component hierarchy is using. This method caters for this use case.
	 * 
	 * @return The set of resources contained in the hierarchy that is rooted in
	 *         this component.
	 */
	Set<Resource> gatherResources();

	/**
	 * When resource have cron expression associated with them, the components
	 * should honor this interface by stopping running whatever it is they are
	 * showing right now in order to show the resource specified by this
	 * interface.
	 * 
	 * This only makes sense for the non-container components. The abstract
	 * component has a void implementation of this interface.
	 * 
	 * @param resource
	 *            The resource to run.
	 */
