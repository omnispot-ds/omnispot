...
create table DEPLOYMENT (ID bigint not null, URL varchar(512) not null, NAME varchar(50) not null, CRC varchar(128), LOCAL_FILE varchar(512), STATUS smallint not null, primary key (ID));
