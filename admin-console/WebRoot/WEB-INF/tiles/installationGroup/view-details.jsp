...
<div id="form_container">
	...
	<div class="tab-navigation">
		<ul class="tabs">
			<li>
			 	<a href="${pageContext.request.contextPath}/secure/installationGroup/view.do?id=${dataObject.id}">
	...
	<form:form id="form" 
		action="${pageContext.request.contextPath}/secure/instalaltionGroup/viewPs.do"
		...
		<div class="form_description">
			<h2>
				<fmt:message bundle="${msg}" key="group.printscreen.title" />
			</h2>
