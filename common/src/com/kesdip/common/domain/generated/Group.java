...
// Generated 2 Дек 2008 1:57:50 рм by Hibernate Tools 3.2.0.b9
 ...
 * 			
    ...
    public Group(String name, Customer customer) {
        this.name = name;
        this.customer = customer;
    }
    public Group(String name, String comments, Customer customer, Set<Installation> installations) {
       this.name = name;
